...
CFG_LOC = (
    pathlib.Path(appdirs.site_config_dir(appname="time_tracker", appauthor="H3isenb3rg"), "config.toml")
)
...
class ConfigClass:
    ...
    def __post_init__(self):
        ...
        self.payload_sentric_buckets = (
            {"page_size": 100, "filter": sentric_buckets_filter}
            if self.bucket_area is not None
            else {"page_size": 100}
        )
